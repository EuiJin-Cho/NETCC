...
<body>
        ...
        <!-- Top box -->
			...
			<div class="tm-paging-links">
                                <nav>
                                        <ul>
                                                <li class="tm-paging-item"><a href="tshirts.jsp" class="tm-paging-link active">티셔츠 T-shirts</a></li>
			...
			<div class="tm-paging-links">
                        ...
                        <%
                                ...
                                if(pstmt.execute("select * from clothes where category='t-shirts' order by readcount desc")) {
