        ...
        <!-- Top box -->
                ...
                <main>
                        ...
                        <div class="tm-paging-links">
                                <nav>
                                        <ul>
                                                ...
                                                <li class="tm-paging-item"><a href="neat_sweater.jsp" class="tm-paging-link active">니트 / 스웨터 Neat / Sweater </a></li>
                                                <li class="tm-paging-item"><a href="shirts.jsp" class="tm-paging-link">셔츠  Shirts </a></li>
                                                <li class="tm-paging-item"><a href="pants_skirt.jsp" class="tm-paging-link">가상피팅 </a></li>
                                        </ul>
                                </nav>
                        </div>
                        ...
                        <%
                                ...
                                if(pstmt.execute("select * from clothes where category='neat_sweater' order by readcount desc")) {
