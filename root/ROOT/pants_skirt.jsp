...
<body>
        ...
        <!-- Top box -->
                ...
                <div class="placeholder">
                        <div class="parallax-window" data-parallax="scroll"><img src="img/background2.jpg" class="tm-background" />
                                <div class="tm-header">
                ...
                <main>
                        ...
                        <div class="tm-paging-links">
                                <nav>
                                        <ul>
                                                ...
                                                <li class="tm-paging-item"><a href="pants_skirt.jsp" class="tm-paging-link active">가상피팅</a></li>
                                        </ul>
                                </nav>
                        </div>
                        <!-- Gallery -->
                        <%
                                ...
                                if(pstmt.execute("select * from clothes where category='pants' order by readcount desc")) {
                        ...
                        %>
                                ...
                                <div id="tm-gallery-page-pizza" class="tm-gallery-page">
                                        <article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                                                <figure>
							<!-- <a href = "detail.jsp?category=<%= rs.getString("category") %>&brand=<%= rs.getString("brand") %>&name=<%= rs.getString("name")%>"<i> -->
							<a href = "fitting<%= count %>.jsp"<i>
