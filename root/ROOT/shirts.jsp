        ...
        <!-- Top box -->
                ...
                <main>
                        ...
                        <div class="tm-paging-links">
                                <nav>
                                        <ul>
                                                ...
                                                <li class="tm-paging-item"><a href="shirts.jsp" class="tm-paging-link active">셔츠  Shirts </a></li>
                        ...
                        <%
                                ...
                                if(pstmt.execute("select * from clothes where category='shirts' order by readcount desc")) {
